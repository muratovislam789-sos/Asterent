      ...
      <div className="card overflow-hidden cursor-pointer">
        <div className={`relative overflow-hidden ${compact ? 'h-40' : 'h-52'}`}>
          ...
          <button
            ...
            className={`absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 ${favorited ? 'bg-error text-white shadow-lg' : 'bg-white/90 text-gray-400 hover:text-error hover:bg-white'
              }`}
          >
